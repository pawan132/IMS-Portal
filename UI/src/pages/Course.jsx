...
const Course = () => {
    ...
    const handleAdd = () => {
        ...
        if (roleId !== '2') {
            fetchModuleDataByBranch(branchId);
    ...
    useEffect(() => {
        if (modalData.baseFees && modalData.tax) {
            setModalData(prevData => ({
                ...prevData,
                totalFees: Math.round(Number(prevData.baseFees) + (Number(prevData.baseFees) * (Number(prevData.tax) / 100))+Number(prevData.booksFees)+(Number(prevData.booksFees) * (Number(prevData.bookstax) / 100)))
            }));
        } else {
            setModalData(prevData => ({
                ...prevData,
    ...
    }, [modalData.baseFees, modalData.tax,modalData.booksFees, modalData.bookstax]);
